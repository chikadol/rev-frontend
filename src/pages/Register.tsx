                    ...
                    <div>
                        ...
                        <div style={{ 
                            ...
                            <label style={{ 
                                ...
                                background: role === 'USER' ? 'rgba(139, 92, 246, 0.1)' : 'transparent',
                                transition: 'all var(--transition-base)',
                                fontWeight: role === 'USER' ? '600' : '500',
                                color: role === 'USER' ? 'var(--color-primary)' : 'var(--color-text)'
                            }}>
                                <input
                                    type="radio"
                                    name="role"
                            ...
                            <label style={{ 
                                ...
                                padding: 'var(--spacing-md)',
                                borderRadius: 'var(--radius-md)',
                                border: `2px solid ${role === 'IDOL' ? 'var(--color-accent)' : 'var(--color-border)'}`,
                                background: role === 'IDOL' ? 'rgba(236, 72, 153, 0.1)' : 'transparent',
                                transition: 'all var(--transition-base)',
                                fontWeight: role === 'IDOL' ? '600' : '500',
                                color: role === 'IDOL' ? 'var(--color-accent)' : 'var(--color-text)'
                            }}>
                                <input
                                    type="radio"
                                    name="role"
